...
func main() {
	...
	*/
	...
	http.HandleFunc("/", func(writer http.ResponseWriter, request *http.Request) {
		temp,err := template.ParseFiles("C:/Users/lei17/Desktop/HTML系列/Smart_mine_clearance.html")
		if err!=nil{
			fmt.Println("trmplate err",err)
			return
		}
	//	temp.Execute(writer,temp)
			temp.Execute(writer,movie)
